...
// --- INLINE SVG ICONS (Bulletproof for Vercel) ---
const Icons = {
  Layout: () => <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="7" height="9" x="3" y="3" rx="1"/><rect width="7" height="5" x="14" y="3" rx="1"/><rect width="7" height="9" x="14" y="12" rx="1"/><rect width="7" height="5" x="3" y="16" rx="1"/></svg>,
  Target: () => <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>,
  MapPin: () => <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>,
  Glass: () => <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15.2 3a2 2 0 0 1 1.6 2.4l-1.1 6.6a2 2 0 0 1-2 1.7H10.3a2 2 0 0 1-2-1.7l-1.1-6.6A2 2 0 0 1 8.8 3z"/><path d="M10 22h4"/><path d="M12 13.7V22"/></svg>,
  Trend: () => <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>
};
...
const App = () => {
  ...
  const kpiData = [
    { name: 'Jameson Attach Rate', value: '28.4%', change: '+12.1%' },
    { name: 'Avg. Attendance Lift', value: '+42%', change: '+8.5%' },
    { name: 'UGC Volume', value: '14.2k', change: '+204%' },
    { name: 'Repeat Visitation', value: '18.5%', change: '+4.2%' },
  ];
                ...
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={experimentalResults}>
                      ...
                      <Tooltip />
                      <Legend />
                      <Line type="monotone" dataKey="treatment" name="Activated Venues" stroke="#065f46" strokeWidth={4} dot={{r: 4, fill: '#065f46'}} activeDot={{r: 6}} />
          ...
          {activeTab === 'product' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-in zoom-in-95 duration-500">
              ...
              <div className="bg-emerald-900 p-8 rounded-xl text-white shadow-lg flex flex-col justify-center">
                 <h4 className="text-emerald-400 font-bold uppercase text-xs tracking-widest mb-2">Key Insight</h4>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left">
                  <thead className="bg-slate-50">
                    <tr>
                      <th className="p-4 text-xs font-bold text-slate-400 uppercase tracking-widest">City</th>
                      <th className="p-4 text-xs font-bold text-slate-400 uppercase tracking-widest">Attach Rate</th>
                      <th className="p-4 text-xs font-bold text-slate-400 uppercase tracking-widest">Attendance Lift</th>
                      <th className="p-4 text-xs font-bold text-slate-400 uppercase tracking-widest">Depletion</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100">
                    {marketData.map((m, i) => (
                      <tr key={i} className="hover:bg-slate-50 transition-colors group">
                        ...
                        <td className="p-4"><span className="text-emerald-700 font-bold px-2 py-1 bg-emerald-50 rounded">{m.attach}%</span></td>
                        <td className="p-4 text-slate-600 font-medium">+{m.lift}%</td>
                        <td className="p-4 text-slate-800 font-bold">{m.depletion} Cases</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
